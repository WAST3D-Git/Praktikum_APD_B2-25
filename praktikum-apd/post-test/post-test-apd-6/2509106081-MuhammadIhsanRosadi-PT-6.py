            ...
            while True:
                ...
                if pilih == "1":
                    ...
                    if judul != "" and klien != "":
                        ...
                        print("Judul dan Klien wajib diisi!")
                    input("Tekan Enter Untuk Melanjutkan...")
                ...
                # UPDATE
                    ...
                    if nomor.isdigit():
                        ...
                        if 0 <= nomor < len(projects):
                            while True:
                                os.system('cls' if os.name == 'nt' else 'clear')
                                print(f"=== UBAH PROYEK: {projects[nomor]['judul']} ===")
                                print("1. Judul")
                                print("2. Deskripsi")
                                print("3. Software")
                                print("4. Deadline")
                                ...
                                if pilih_update == "1":
                                    projects[nomor]["judul"] = input("Masukkan judul baru: ")
                                elif pilih_update == "2":
                                    projects[nomor]["deskripsi"] = input("Masukkan deskripsi baru: ")
                                elif pilih_update == "3":
                                    projects[nomor]["software"] = input("Masukkan software baru: ")
                                elif pilih_update == "4":
                                    projects[nomor]["deadline"] = input("Masukkan deadline baru: ")
                                elif pilih_update == "5":
                                    projects[nomor]["klien"] = input("Masukkan nama klien baru: ")
                                elif pilih_update == "6":
                                    projects[nomor]["status"] = input("Masukkan status baru: ")
                                elif pilih_update == "7":
                                    break
                                else:
